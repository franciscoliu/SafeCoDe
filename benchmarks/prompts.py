"""Task prompts for MSSBench.

Verbatim from the official MSSBench release (MIT, Copyright (c) 2024 UCSC
ERIC Lab, https://github.com/eric-ai-lab/MSSBench).

Only the two instruction-following prompts SafeCoDe actually uses are kept;
upstream's chain-of-thought and multi-agent prompt variants are not used by
this codebase.
"""

__all__ = ["PROMPT_CHAT_IF", "PROMPT_EMBODIED_IF"]
