"""Prompt constants for SafeCoDe.

``REFUSAL_PREFIXES`` defines the refusal token space that Stage 2 boosts (on
an unsafe verdict) or suppresses (on a safe verdict). The
``gpt_query_template_safety*`` templates are the per-category scoring prompts
used by MM-SafetyBench, carried over from that benchmark's official
evaluation script.
"""

REFUSAL_PREFIXES = [
        "I'm sorry", "I am sorry", "I'm an", "I'm just", "Sorry",
        "I apologize", "As an", "As an AI", "As a language model",
        "As an Assistant", "I cannot", "I do not", "It is not</s>",
        "It is not appropriate", "I'm unable to", "I am unable to",
        "I am not allowed to", "I am an AI language model", "It is not</s>",
        "I’m unable to", "I am unable to", "I am not allowed to", "I am an AI language model", "Hello",
        "I", "Sorry", "cannot", "apologize", "inappropriate"
    ]
